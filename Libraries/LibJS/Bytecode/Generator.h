...
public:
    ...
    void emit_put_by_value(ScopedOperand const& base, ScopedOperand property, ScopedOperand const& src, Bytecode::Op::PropertyKind, Optional<IdentifierTableIndex> const& base_identifier);
    void emit_put_by_value_with_this(ScopedOperand const& base, ScopedOperand property, ScopedOperand const& this_value, ScopedOperand const& src, Bytecode::Op::PropertyKind);
