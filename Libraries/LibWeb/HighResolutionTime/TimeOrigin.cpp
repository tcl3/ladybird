...
DOMHighResTimeStamp coarsen_time(DOMHighResTimeStamp timestamp, bool cross_origin_isolated_capability)
{
    ...
    auto time_resolution_microseconds = 0.1;
    ...
    if (cross_origin_isolated_capability)
        time_resolution_microseconds = 0.005;
    ...
    timestamp = floor(timestamp / time_resolution_microseconds) * time_resolution_microseconds;
