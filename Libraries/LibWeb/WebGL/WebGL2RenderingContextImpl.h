...
public:
    ...
    void tex_image3d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::Long internalformat, WebIDL::Long width, WebIDL::Long height, WebIDL::Long depth, WebIDL::Long border, WebIDL::UnsignedLong format, WebIDL::UnsignedLong type, GC::Root<WebIDL::ArrayBufferView> const& src_data);
    void tex_image3d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::Long internalformat, WebIDL::Long width, WebIDL::Long height, WebIDL::Long depth, WebIDL::Long border, WebIDL::UnsignedLong format, WebIDL::UnsignedLong type, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset);
    ...
    void uniform1ui(GC::Root<WebGLUniformLocation> const& location, WebIDL::UnsignedLong v0);
    void uniform2ui(GC::Root<WebGLUniformLocation> const& location, WebIDL::UnsignedLong v0, WebIDL::UnsignedLong v1);
    void uniform3ui(GC::Root<WebGLUniformLocation> const& location, WebIDL::UnsignedLong v0, WebIDL::UnsignedLong v1, WebIDL::UnsignedLong v2);
    void uniform4ui(GC::Root<WebGLUniformLocation> const& location, WebIDL::UnsignedLong v0, WebIDL::UnsignedLong v1, WebIDL::UnsignedLong v2, WebIDL::UnsignedLong v3);
    ...
    void delete_sampler(GC::Root<WebGLSampler> const& sampler);
    void bind_sampler(WebIDL::UnsignedLong unit, GC::Root<WebGLSampler> const& sampler);
    void sampler_parameteri(GC::Root<WebGLSampler> const& sampler, WebIDL::UnsignedLong pname, WebIDL::Long param);
    void sampler_parameterf(GC::Root<WebGLSampler> const& sampler, WebIDL::UnsignedLong pname, float param);
    GC::Root<WebGLSync> fence_sync(WebIDL::UnsignedLong condition, WebIDL::UnsignedLong flags);
    void delete_sync(GC::Root<WebGLSync> const& sync);
    WebIDL::UnsignedLong client_wait_sync(GC::Root<WebGLSync> const& sync, WebIDL::UnsignedLong flags, WebIDL::UnsignedLongLong timeout);
    JS::Value get_sync_parameter(GC::Root<WebGLSync> const& sync, WebIDL::UnsignedLong pname);
    void bind_buffer_base(WebIDL::UnsignedLong target, WebIDL::UnsignedLong index, GC::Root<WebGLBuffer> const& buffer);
    void bind_buffer_range(WebIDL::UnsignedLong target, WebIDL::UnsignedLong index, GC::Root<WebGLBuffer> const& buffer, WebIDL::LongLong offset, WebIDL::LongLong size);
    JS::Value get_active_uniforms(GC::Root<WebGLProgram> const& program, Vector<WebIDL::UnsignedLong> uniform_indices, WebIDL::UnsignedLong pname);
    WebIDL::UnsignedLong get_uniform_block_index(GC::Root<WebGLProgram> const& program, String const& uniform_block_name);
    JS::Value get_active_uniform_block_parameter(GC::Root<WebGLProgram> const& program, WebIDL::UnsignedLong uniform_block_index, WebIDL::UnsignedLong pname);
    Optional<String> get_active_uniform_block_name(GC::Root<WebGLProgram> const& program, WebIDL::UnsignedLong uniform_block_index);
    void uniform_block_binding(GC::Root<WebGLProgram> const& program, WebIDL::UnsignedLong uniform_block_index, WebIDL::UnsignedLong uniform_block_binding);
    GC::Root<WebGLVertexArrayObject> create_vertex_array();
    void delete_vertex_array(GC::Root<WebGLVertexArrayObject> const& vertex_array);
    bool is_vertex_array(GC::Root<WebGLVertexArrayObject> const& vertex_array);
    void bind_vertex_array(GC::Root<WebGLVertexArrayObject> const& array);
    void buffer_data(WebIDL::UnsignedLong target, WebIDL::LongLong size, WebIDL::UnsignedLong usage);
    void buffer_data(WebIDL::UnsignedLong target, GC::Root<WebIDL::BufferSource> const& src_data, WebIDL::UnsignedLong usage);
    void buffer_sub_data(WebIDL::UnsignedLong target, WebIDL::LongLong dst_byte_offset, GC::Root<WebIDL::BufferSource> const& src_data);
    void buffer_data(WebIDL::UnsignedLong target, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLong usage, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong length);
    void buffer_sub_data(WebIDL::UnsignedLong target, WebIDL::LongLong dst_byte_offset, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong length);
    ...
    void tex_image2d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::Long internalformat, WebIDL::Long width, WebIDL::Long height, WebIDL::Long border, WebIDL::UnsignedLong format, WebIDL::UnsignedLong type, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset);
    ...
    void tex_sub_image2d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::Long xoffset, WebIDL::Long yoffset, WebIDL::Long width, WebIDL::Long height, WebIDL::UnsignedLong format, WebIDL::UnsignedLong type, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset);
    void compressed_tex_image2d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::UnsignedLong internalformat, WebIDL::Long width, WebIDL::Long height, WebIDL::Long border, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length_override);
    void compressed_tex_sub_image2d(WebIDL::UnsignedLong target, WebIDL::Long level, WebIDL::Long xoffset, WebIDL::Long yoffset, WebIDL::Long width, WebIDL::Long height, WebIDL::UnsignedLong format, GC::Root<WebIDL::ArrayBufferView> const& src_data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length_override);
    void uniform1fv(GC::Root<WebGLUniformLocation> const& location, Float32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform2fv(GC::Root<WebGLUniformLocation> const& location, Float32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform3fv(GC::Root<WebGLUniformLocation> const& location, Float32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform4fv(GC::Root<WebGLUniformLocation> const& location, Float32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform1iv(GC::Root<WebGLUniformLocation> const& location, Int32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform2iv(GC::Root<WebGLUniformLocation> const& location, Int32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform3iv(GC::Root<WebGLUniformLocation> const& location, Int32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform4iv(GC::Root<WebGLUniformLocation> const& location, Int32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix2fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix3fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix4fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
