...
void FontPlugin::update_generic_fonts()
{
    ...
    Vector<FlyString> monospace_fallbacks { "Andale Mono"_fly_string, "Courier New"_fly_string, "Courier"_fly_string, "FreeMono"_fly_string, "OCR A Std"_fly_string, "Noto Sans Mono"_fly_string, "DejaVu Sans Mono"_fly_string, "Droid Sans Mono"_fly_string, "Liberation Mono"_fly_string, "Noto Sans Mono CJK SC"_fly_string, "Noto Sans Mono CJK TC"_fly_string, "Noto Sans Mono CJK JP"_fly_string, "Noto Sans Mono CJK KR"_fly_string };
    Vector<FlyString> sans_serif_fallbacks { "Arial"_fly_string, "Helvetica"_fly_string, "Verdana"_fly_string, "Trebuchet MS"_fly_string, "Gill Sans"_fly_string, "Noto Sans"_fly_string, "Avantgarde"_fly_string, "Optima"_fly_string, "Arial Narrow"_fly_string, "Liberation Sans"_fly_string, "Roboto"_fly_string, "Noto Sans CJK SC"_fly_string, "Noto Sans CJK TC"_fly_string, "Noto Sans CJK JP"_fly_string, "Noto Sans CJK KR"_fly_string };
    Vector<FlyString> serif_fallbacks { "Times"_fly_string, "Times New Roman"_fly_string, "Didot"_fly_string, "Georgia"_fly_string, "Palatino"_fly_string, "Bookman"_fly_string, "New Century Schoolbook"_fly_string, "American Typewriter"_fly_string, "Liberation Serif"_fly_string, "Roman"_fly_string, "Noto Serif"_fly_string, "Noto Serif CJK SC"_fly_string, "Noto Serif CJK TC"_fly_string, "Noto Serif CJK JP"_fly_string, "Noto Serif CJK KR"_fly_string };
