...
public:
    ...
    Optional<size_t> find_code_unit_offset_ignoring_case(Utf16View const& needle, size_t start_offset) const;
    Optional<size_t> find_code_unit_offset(Utf16View const& needle, size_t start_offset) const;
