...
static Vector<ByteString> create_arguments(ByteString const& webdriver_endpoint, bool headless, bool expose_experimental_interfaces, bool force_cpu_painting, bool enable_sandbox, Optional<StringView> debug_process, Optional<StringView> default_time_zone)
{
...
ErrorOr<int> ladybird_main(Main::Arguments arguments)
{
    ...
    args_parser.add_option(enable_sandbox, "Launch browser with helper process sandboxing enabled", "enable-sandbox");
    ...
    server->on_ready_to_accept = [&] {
        ...
        auto launch_browser_callback = [&](ByteString const& webdriver_endpoint, bool headless) {
            auto arguments = create_arguments(webdriver_endpoint, headless, expose_experimental_interfaces, force_cpu_painting, enable_sandbox, debug_process, default_time_zone);
